  ...
  return (
    <AppShell nav={FINANCE_NAV}>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <StatCard label="Open alerts" value={openCount} icon={<ShieldAlert className="h-4 w-4" />} />
        <StatCard label="Critical" value={criticalCount} icon={<ShieldAlert className="h-4 w-4" />} />
        <StatCard
      ...
      <h2 className="mt-6 mb-2 text-sm font-semibold text-muted-foreground">Highest risk collections</h2>
      <ul className="surface-card divide-y divide-border overflow-hidden">
